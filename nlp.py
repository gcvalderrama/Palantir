...
def human_topic_analysis(topic_dicts):
    ...
    for i, topic in enumerate(topic_dicts):
        ...
        name = input("Name this topic: ")
        keep = int(input("Keep? (0 or 1): "))
        if name == 'Q':
            return output
        # push to list
        output[i] = (name, keep)
...
=======
        stopwords.write('\n'.join(ALL_STOPWORDS))
>>>>>>> 70238793bb958f4ee75c235455bd312fb10196e6
    ...
    for news_file in news:
        ...
        with open("CleanTokenize/"+fname, 'w') as modified:
<<<<<<< HEAD
            modified.writelines(tokenize_cont)
=======
            modified.write('\n'.join(tokenize_cont))
>>>>>>> 70238793bb958f4ee75c235455bd312fb10196e6
